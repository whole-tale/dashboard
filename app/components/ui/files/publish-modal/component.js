...
export default Component.extend({
    ...
    nonOptionalFile: computed(function () {
        return ['tale.yaml', 'docker-environment.tar.gz', 'license.txt', 'science_metadata.xml'];
    }),
    // A map that connects the repository dropdown to a url
    repositories: computed(function () {
        return [{
    ...
    availableLicenses: computed(function () {
        return [];
    }),
